  ...
  return (
    <section className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
      ...
      <div className="mb-4 grid gap-2 sm:grid-cols-4">
        <input value={search} onChange={(event) => setSearch(event.currentTarget.value)} placeholder="Search by name or SKU" className="rounded-lg border border-slate-300 px-3 py-2 text-sm" />
        <select value={brandFilter} onChange={(event) => setBrandFilter(event.currentTarget.value)} className="rounded-lg border border-slate-300 px-3 py-2 text-sm">
        ...
        <select value={categoryFilter} onChange={(event) => setCategoryFilter(event.currentTarget.value)} className="rounded-lg border border-slate-300 px-3 py-2 text-sm">
        ...
        <select value={statusFilter} onChange={(event) => setStatusFilter(event.currentTarget.value as "all" | "active" | "inactive")} className="rounded-lg border border-slate-300 px-3 py-2 text-sm">
                      ...
                      {([
                        ...
                        return (
                          <button
                            ...
                            className={`rounded-full px-2 py-1 text-xs font-semibold ${enabled ? "bg-emerald-100 text-emerald-700" : "bg-slate-200 text-slate-600"}`}
                          >
                            {label}
                          </button>
                        );
